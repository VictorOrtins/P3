public class DoubleLinkedList<T>{
    ...
    public T valueInPosition(int position) throws EmptyListException, InvalidPositionException{
    ...
    public T remove(int position) throws EmptyListException, InvalidPositionException{
        if(isEmpty()){
            throw new EmptyListException();
        }
